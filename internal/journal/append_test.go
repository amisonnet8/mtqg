...
func TestAppendValidation(t *testing.T) {
	tests := []struct {
		...
		{"at with an empty path", Event{Op: OpCreate, Type: TypeMemo, Text: "x", At: &At{Line: 3}}},
		{"at with a negative line", Event{Op: OpCreate, Type: TypeMemo, Text: "x", At: &At{Path: "a.go", Line: -1}}},
